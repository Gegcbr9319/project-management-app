import { IToken } from 'store/tokenSlice';
...
export interface IGetUserByIdOptions extends IAuth {
  userId: string;
}

export interface IUpdateUserByIdOptions extends IAuth, IGetUserByIdOptions {
  body: Omit<IUser, '_id'>;
}

export type IDeleteUserByIdOptions = IGetUserByIdOptions;
...
export type IGetBoardsSetByUserIdOptions = IGetUserByIdOptions;
